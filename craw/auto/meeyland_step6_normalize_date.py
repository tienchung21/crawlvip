...
def main():
    ...
    print("=== meeyland_step6_normalize_date.py ===")
    ...
    update_sql = """
        ...
        SET 
            ...
            median_flag = 1,
            process_status = 6, 
            last_script = 'meeyland_step6_normalize_date.py'
    ...
    print(f"-> Assigned std_date, median_flag=1 and finalized status=6 for {updated} meeyland records in {time.time()-start:.2f}s.")
